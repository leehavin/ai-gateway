...
using AIAdmin.Workflow.Services.InstanceDtos;
using AIAdmin.Workflow.Services.WfDefiniationDtos;
using Newtonsoft.Json;
using WorkflowCore.Models.DefinitionStorage.v1;
using WorkflowCore.Services.DefinitionStorage;

namespace AIAdmin.Workflow.Services;
/// <summary>
/// 工作流定义服务
/// </summary>
...
public class DefinitionService(ISqlSugarClient db, IDefinitionLoader definitionLoader) : ApplicationService
{
    ...
    private static string GetWorkflowContent(WfDefinitionEntity entity)
    {
        var v1 = new DefinitionSourceV1()
        {
            ...
            DataType = "AIAdmin.Workflow.DataTypes.GeneralAuditingDefinition, AIAdmin.Workflow",
