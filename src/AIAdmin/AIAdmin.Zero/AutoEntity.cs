...
public class AutoEntity : ISingletonDependency
{
    ...
    public void Initialization()
    {
        ...
        //命名空间
        StringBuilder sb = new("namespace AIAdmin.SqlSugar.Entity;\r\n");

        sb.Append($"\r\n/// <summary>");
        sb.Append($"\r\n/// {table.Description}");
        sb.Append($"\r\n/// </summary>");
        sb.Append($"\r\n[SugarTable(\"{table.Name.ToLower()}\")]");
        ...
        foreach (var columnInfo in columns)
        {
            ...
            if (containBase && baseColumnName.Contains(columnInfo.DbColumnName.ToLower()))
            {
                //排除base
                continue;
            }
